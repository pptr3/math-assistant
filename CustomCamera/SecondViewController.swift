...
class SecondViewController: UIViewController {
        ...
        private func getNumber(from chars: [Character], from index: Int ) -> String? {
            ...
            if Array(myStringNumber).first == "{" { //means that is coloumn operation
                ...
                if !myStringNumber.containsIgnoringCase2("x") && !myStringNumber.containsIgnoringCase2("+") && !myStringNumber.containsIgnoringCase2("-") && !myStringNumber.containsIgnoringCase2("/") && !myStringNumber.containsIgnoringCase2("*") {
                    var charMyStringNumber = Array(myStringNumber)
                    for index in charMyStringNumber.indices {
                        if charMyStringNumber[index] == "}" {
        ...
        func checkIfOperationIsWellFormatted(for operation: String) -> Bool {
            ...
            if !String(charsOperation[0]).isNumber2 || !String(charsOperation[charsOperation.count - 1]).isNumber2 {
                return false
            }
            var equals = false
            var operators = false
     ...
     /*   @IBAction func savePhoto(_ sender: Any) {
        ...
        */
        ...
        private func calculateHorizontalForeground(from pixelBuffer:  UnsafeMutablePointer<SecondViewController.RGBA32>, withWidth width: Int, andHeight height: Int) -> Array<Int>? {
        ...
        private func calculateVerticalForeground(from pixelBuffer:  UnsafeMutablePointer<SecondViewController.RGBA32>, withWidth width: Int, from start: Int, to stop: Int) -> Array<Int>? {
        ...
        private func fireHorizontalGrid(for sums: Array<CGPoint>, in pixelBuffer:  UnsafeMutablePointer<SecondViewController.RGBA32>, withWidth width: Int, andHeight height: Int) -> Array<CGPoint>? {
        ...
        private func fireVerticalGrid(for sums3: Array<CGPoint>, in pixelBuffer: UnsafeMutablePointer<SecondViewController.RGBA32>, withWidth width: Int, andHeight height: Int) {
            var start = 0
            var stop = 0
        ...
        private func drawHorizontalLines(for sums3: Array<CGPoint>, in pixelBuffer:  UnsafeMutablePointer<SecondViewController.RGBA32>, withWidth width: Int, andHeight height: Int) {
            var startDrawing = 0
        ...
        private func drawVerticalLines(for sums3: Array<CGPoint>, in pixelBuffer:  UnsafeMutablePointer<SecondViewController.RGBA32>, withWidth width: Int, from start: Int, to stop: Int) {
            var startDrawing = 0
            for index in sums3.indices {
                if sums3[index].y == 0 {
...
extension String  {
    ...
    func contains2(_ find: String) -> Bool{
        return self.range(of: find) != nil
    }
    
    func containsIgnoringCase2(_ find: String) -> Bool{
